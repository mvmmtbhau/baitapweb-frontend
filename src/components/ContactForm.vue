...
import { Form, Field, ErrorMassage } from "vee-validate";
...
export default {
    ...
    data() {
        ...
        return {
            //Chúng ta sẽ không muốn hiệu chỉnh props, nên sẽ tạo biến cục bộ
